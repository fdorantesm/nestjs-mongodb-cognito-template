...
} from '@/modules/auth/domain/interfaces/roles.repository.interface';
import {
  PERMISSIONS_REPOSITORY_TOKEN,
} from '@/modules/auth/domain/interfaces/permissions.repository.interface';
import {
  ROLE_PERMISSIONS_REPOSITORY_TOKEN,
} from '@/modules/auth/domain/interfaces/role-permissions.repository.interface';
...
@Module({
  ...
  providers: [
    ...
    {provide: USERS_REPOSITORY_TOKEN,useClass: UsersMemoryRepository},
    {provide: PROFILES_REPOSITORY_TOKEN,useClass: ProfilesMemoryRepository},
    {
      provide: USER_EXTRAS_REPOSITORY_TOKEN,
      useClass: UserExtrasMemoryRepository,
    },
    {provide: ROLES_REPOSITORY_TOKEN,useClass: RolesMemoryRepository},
    {
